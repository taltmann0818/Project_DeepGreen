...
class CharlieMungerAgent:
    ...
    def analyze_moat_strength(self, metrics: list, financial_line_items: list) -> dict:
        """
    ...
    def analyze_management_quality(self, financial_line_items: list, insider_trades: list) -> dict:
        """
    ...
    def analyze_predictability(self, financial_line_items: list) -> dict:
        """
    ...
    def calculate_munger_valuation(self, financial_line_items: list, market_cap: float) -> dict:
        """
    ...
    def analyze_news_sentiment(self, news_items: list) -> str:
        """
